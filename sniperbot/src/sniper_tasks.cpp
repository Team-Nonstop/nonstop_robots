...
bool SniperNode::getReadyToWork()
{
  if (initialized_)
  {
    return leaveNest();
...
bool SniperNode::cleanupAndSuccess()
{
...
bool SniperNode::cleanupAndError()
{
